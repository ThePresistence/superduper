...
! calculating the product of one block of the CI Hamiltonian and a set of
! test vectors of specific symmetry for use with direct CI.
!
...
Public :: ShapeDrivenProdMatIrrep
...
Contains
  ...
  ! This subroutine is analogous to CalcProdMat in module gugaloops with Irrep>0.
  ! Arguments ProdTrans, CICTrans, and Hii correspond to one block of the CI matrix.
  !
  Subroutine ShapeDrivenProdMatIrrep(Flags, ProdTrans, CICTrans, Hii, OneInt, TwoInt, Irrep, m0)
    Implicit None
    ...
    ! CombineSym22ikjl.
    !
    Call CombineOne      (Flags, ProdTrans, CICTrans, OneInt, Irrep, m0)
    Call CombineSym13ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Call CombineSym22ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Call CombineSym22ikjl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Call CombineSym22half(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Call CombineSym31ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    ...
    Call Complete(Flags, ProdTrans, CICTrans, OneInt, Flags%OneLoop, Flags%iOff1(1), Flags%iLast1(1), Irrep, m0)
    Call Complete(Flags, ProdTrans, CICTrans, TwoInt, Flags%TwoLoop, Flags%iOff2(1), Flags%iLast2(1), Irrep, m0)
  End Subroutine ShapeDrivenProdMatIrrep
  ...
  !
  Subroutine CombineOne(Flags, ProdTrans, CICTrans, OneInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
  ...
  !
  Subroutine CombineSym13ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
  ...
  !
  Subroutine CombineSym22ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine CombineSym22ikjl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine CombineSym22half(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine CombineSym31ijkl(Flags, ProdTrans, CICTrans, TwoInt, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine Complete(Flags, ProdTrans, CICTrans, MOInt, Loop, iOff, iLast, Irrep, m0)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: ProdTrans(:,:), CICTrans(:,:)
