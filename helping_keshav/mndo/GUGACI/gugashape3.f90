...
! calculating the product of the complete CI Hamiltonian and a test vector of
! unspecified symmetry for use with direct CI.
!
...
Contains
  ...
  ! is analogous to CalcProdVec in module gugaloops with Irrep=0 and i0=0.
  !
  Subroutine ShapeDrivenProdVec(Flags, Prod, CIV, Hii, OneInt, TwoInt)
    Implicit None
    ...
    ! CombineSym22ikjl.
    !
    Call CombineOne      (Flags, Prod, CIV, OneInt)
    Call CombineSym13ijkl(Flags, Prod, CIV, TwoInt)
    Call CombineSym22ijkl(Flags, Prod, CIV, TwoInt)
    Call CombineSym22ikjl(Flags, Prod, CIV, TwoInt)
    Call CombineSym22half(Flags, Prod, CIV, TwoInt)
    Call CombineSym31ijkl(Flags, Prod, CIV, TwoInt)
    ...
    Call Complete(Flags, Prod, CIV, OneInt, Flags%OneLoop, Flags%iOff1(1), Flags%iLast1(1))
    Call Complete(Flags, Prod, CIV, TwoInt, Flags%TwoLoop, Flags%iOff2(1), Flags%iLast2(1))
  End Subroutine ShapeDrivenProdVec
  ...
  !
  Subroutine CombineOne(Flags, Prod, CIV, OneInt)
    Implicit None
    Type(ShavittControl) :: Flags
  ...
  ! always (ij|kl).
  !
  Subroutine CombineSym13ijkl(Flags, Prod, CIV, TwoInt)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
  ...
  !
  Subroutine CombineSym22ijkl(Flags, Prod, CIV, TwoInt)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine CombineSym22ikjl(Flags, Prod, CIV, TwoInt)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine CombineSym22half(Flags, Prod, CIV, TwoInt)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
    Double Precision     :: TwoInt(:,:)
  ...
  ! is always (ij|kl).
  !
  Subroutine CombineSym31ijkl(Flags, Prod, CIV, TwoInt)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
    Double Precision     :: TwoInt(:,:)
  ...
  !
  Subroutine Complete(Flags, Prod, CIV, MOInt, Loop, iOff, iLast)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: Prod(:), CIV(:)
