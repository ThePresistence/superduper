...
! between two states for the computation of the non-adiabatic coupling.
!
...
Public :: ShapeDrivenDirectNACDen
...
Contains
  ...
  ! two-particle density matrices for computing the non-adiabatic coupling.
  ! This subroutine is analogous to CalcNACDen in module gugaloops.
  ! See also ShapeDrivenDirectNACDenC1 in module gugashape9.
  !
  Subroutine ShapeDrivenDirectNACDen(Flags, OneDen, TwoDen, CIV1, CIV2)
    Implicit None
    ...
    ! A subroutine like CombineAll22iljk does not exist because
    ...
    Call CombineAll13ijkl(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll22ijkl(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll22iill(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll22ikjl(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll22ilil(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll22half(Flags, TwoDen, CIV1, CIV2)
    Call CombineAll31ijkl(Flags, TwoDen, CIV1, CIV2)
  ...
  End Subroutine ShapeDrivenDirectNACDen
  ...
  !
  Subroutine CombineAll13ijkl(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll13ijkl
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll13ijkl(iCombi)%iUpB, Flags%CombiListAll13ijkl(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll13ijkl(iCombi)%iLoB, Flags%CombiListAll13ijkl(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet
             If (Dabs(value) > Tiny) Then
                lexbra = Flags%UpperPart(iUp)%lexbra + Flags%LowerPart(iLo)%lexbra
                lexket = Flags%UpperPart(iUp)%lexket + Flags%LowerPart(iLo)%lexket
       ...
       End Do
    End Do
  End Subroutine CombineAll13ijkl
  ...
  !
  Subroutine CombineAll22ijkl(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll22ijkl
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll22ijkl(iCombi)%iUpB, Flags%CombiListAll22ijkl(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll22ijkl(iCombi)%iLoB, Flags%CombiListAll22ijkl(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet
             If (Dabs(value) > Tiny) Then
                lexbra = Flags%UpperPart(iUp)%lexbra + Flags%LowerPart(iLo)%lexbra
                lexket = Flags%UpperPart(iUp)%lexket + Flags%LowerPart(iLo)%lexket
       ...
       End Do
    End Do
  End Subroutine CombineAll22ijkl
  ...
  !
  Subroutine CombineAll22iill(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll22iill
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll22iill(iCombi)%iUpB, Flags%CombiListAll22iill(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll22iill(iCombi)%iLoB, Flags%CombiListAll22iill(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet
             If (Dabs(value) > Tiny) Then
                lexbra = Flags%UpperPart(iUp)%lexbra + Flags%LowerPart(iLo)%lexbra
       ...
       End Do
    End Do
  End Subroutine CombineAll22iill
  ...
  !
  Subroutine CombineAll22ikjl(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll22ikjl
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll22ikjl(iCombi)%iUpB, Flags%CombiListAll22ikjl(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll22ikjl(iCombi)%iLoB, Flags%CombiListAll22ikjl(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet + &
       ...
       End Do
    End Do
  End Subroutine CombineAll22ikjl
  ...
  !
  Subroutine CombineAll22ilil(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll22ilil
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll22ilil(iCombi)%iUpB, Flags%CombiListAll22ilil(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll22ilil(iCombi)%iLoB, Flags%CombiListAll22ilil(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet + &
                     Flags%UpperPart(iUp)%triplet * Flags%LowerPart(iLo)%triplet
             If (Dabs(value) > Tiny) Then
                lexbra = Flags%UpperPart(iUp)%lexbra + Flags%LowerPart(iLo)%lexbra
       ...
       End Do
    End Do
  End Subroutine CombineAll22ilil
  ...
  !
  Subroutine CombineAll22half(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll22half
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll22half(iCombi)%iUpB, Flags%CombiListAll22half(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll22half(iCombi)%iLoB, Flags%CombiListAll22half(iCombi)%iLoE
       ...
       End Do
    End Do
  End Subroutine CombineAll22half
  ...
  !
  Subroutine CombineAll31ijkl(Flags, TwoDen, CIV1, CIV2)
    Implicit None
    Type(ShavittControl) :: Flags
    Double Precision     :: TwoDen(:)
    Double Precision     :: CIV1(:), CIV2(:)
    ...
    ! Loop over all combinations.
    Do iCombi=1, Flags%NumAll31ijkl
       ! Loop over all upper partial loops.
       Do iUp=Flags%CombiListAll31ijkl(iCombi)%iUpB, Flags%CombiListAll31ijkl(iCombi)%iUpE
          ! Loop over all lower partial loops.
          Do iLo=Flags%CombiListAll31ijkl(iCombi)%iLoB, Flags%CombiListAll31ijkl(iCombi)%iLoE
             value = Flags%UpperPart(iUp)%singlet * Flags%LowerPart(iLo)%singlet
             If (Dabs(value) > Tiny) Then
                lexbra = Flags%UpperPart(iUp)%lexbra + Flags%LowerPart(iLo)%lexbra
                lexket = Flags%UpperPart(iUp)%lexket + Flags%LowerPart(iLo)%lexket
       ...
       End Do
    End Do
  End Subroutine CombineAll31ijkl
  ...
  Subroutine CompleteTwoOff(Flags, TwoDen, CIV1, CIV2)
    ...
    Double Precision     :: CIV1(:), CIV2(:)
    ! End of dummy parameters.
    Integer              :: isym, iLoop, ybra, yket, mbra, mket
    Integer              :: ijkl, ij, kl, i, j
    Double Precision     :: value, help

    ! Loop over all complete off-diagonal two-body loops.
    Do isym=1, Flags%NumSym
       Do iLoop=Flags%iOff2(isym), Flags%iLast2(isym)
          ij    = Flags%TwoLoop(iLoop)%p
          kl    = Flags%TwoLoop(iLoop)%q
          ijkl  = CanonicalIndex(ij,kl)
          value = Flags%TwoLoop(iLoop)%value
