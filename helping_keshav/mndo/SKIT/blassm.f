...
c----------------------------------------------------------------------c
     ...
     *                  c,jc,ic,nzmax,iw,ierr) 
      ...
      integer nrow,ncol,ja(*),jb(*),jc(*),ia(nrow+1),ib(*),ic(*),
     +        iw(ncol),job,j,ii,ka,nzmax,jj,jcol,jpos,k,len,ierr,kb
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
     ...
     *     c,jc,ic,nzmax,iw,ierr)
      IMPLICIT NONE
      DOUBLE PRECISION a(*), b(*), c(*) 
      integer nrow,ncol,job,ia(nrow+1),ib(nrow+1),ic(nrow+1),ii,jpos,
     *        iw(ncol),ja(*),jb(*),jc(*),ierr,j,ka,len,jcol,nzmax,kb,k
c-----------------------------------------------------------------------
