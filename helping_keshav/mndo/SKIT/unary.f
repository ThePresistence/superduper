...
c-----------------------------------------------------------------------
      subroutine csort (n,a,ja,ia,iwork) 
...
c----------------------------------------------------------------------- 
      ...
      IMPLICIT NONE
      INTEGER nrow,ncol,ncolb,nnz,last,j,ii,k,ldg,jr,jc 
...
c----------------------------------------------------------------------- 
      ...
      IMPLICIT NONE
      integer nrow,ncol,ja(*),jb(*),ia(nrow+1),ib(nrow+1),iw(ncol),
     +        ndegr(nrow),k,last,ldg,j,jr,ii,jc,nnz
c-----------------------------------------------------------------------
c gets the number of nonzero elements in each row of A+B and the total 
c number of nonzero elements in A+B. 
c-----------------------------------------------------------------------
