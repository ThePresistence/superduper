...
C     *
C     SPECIAL CONVENTION JORBS=0: ATOM J IS AN EXTERNAL POINT
C     CHARGE WITH NO BASIS FUNCTIONS, AND THEREFORE ONLY SOME
C     OF THE PRECOMBINED ELEMENTS YY() ARE NEEDED IN ROTCOH.
C     *
